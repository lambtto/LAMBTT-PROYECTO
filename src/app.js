...
// API 1: US-01 Registro de gastos (Satisface los Criterios de Aceptación)
app.post('/api/gastos', (req, res) => {
    const { descripcion, monto, categoria } = req.body;
    
    // Validaciones estrictas de lógica de negocio (Clases de equivalencia)
    ...
    // Si pasa las validaciones, se guarda en el arreglo en memoria
    const nuevoGasto = { 
        id: Date.now(), 
        descripcion, 
        monto, 
